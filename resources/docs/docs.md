...
The `home-routes` handler in the `guide-me-v1.routes.home` namespace
...
The `home-page` function will in turn call the `guide-me-v1.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/guide_me_v1/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `guide-me-v1.handler` namespace:
...
Request middleware functions are located under the `guide-me-v1.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `guide-me-v1.dev-middleware` namespace found in
...
* Let `mount` know to start the database connection by `require`-ing `guide-me-v1.db.core` in some other namespace.
